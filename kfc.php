...
<body class="dark-mode">
    <header>
        <div class="header-content">
            <img src="images/kfc.png" alt="kfc Logo" class="logo">
            <h1>KFC</h1>
        </div>
    </header>
...
// Fetch reviews for KFC from the database
try {
    $stmt = $pdo->query("SELECT * FROM reviews WHERE restaurant_name = 'KFC' ORDER BY created_at DESC");
...
?>
            ...
            <aside class="sidebar">
                ...
                <?php else: ?>
                    ...
                    <div class="review">
                        <p>"Great food and fast service!"</p>
                    </div>
                    <div class="review">
                        <p>"بەڕاستی ناخۆشبوو"</p>
                    </div>
                <?php endif; ?>
                
                <!-- Review Submission Form -->
                <section class="review-form">
                    <h3 style="font-size: smaller; font-weight: 300;">Write a Review</h3>
                    <form action="submit_review.php" method="post">
                        <input type="hidden" name="restaurant_name" value="KFC">
                        <textarea style="width: 95%;" name="review" id="review-text" rows="4" placeholder="Write your review here..." required></textarea>
                        <button style="width: 100%;" type="submit" class="submit-btn">Submit</button>
                    </form>
                </section>
            </aside>
        </div>
