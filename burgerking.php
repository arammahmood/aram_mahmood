...
<body class="dark-mode">
    <header>
        <div class="header-content">
            <img src="images/burgerking.png" alt="kfc Logo" class="logo">
            <h1>Bugerking</h1>
        </div>
    </header>
        ...
        <div class="content-wrapper">
            ...
            <section class="restaurant-info">
                <div class="description">
                    <p>Bugerking the best of fast food.</p>
                </div>
...
// Fetch reviews for Burger King from the database
try {
...
<!-- Rest of your HTML code for Burger King page -->

<aside class="sidebar">
    <h2>Customer Reviews for Burger King</h2>
    
    <?php if ($review_added): ?>
        <div class="success-message" style="background-color: #4CAF50; color: white; padding: 10px; border-radius: 4px; margin-bottom: 10px;">
            Your review for Burger King has been submitted successfully!
        </div>
    <?php endif; ?>
    ...
    <?php if (!empty($reviews)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <!-- Default Burger King-specific reviews -->
        <div class="review">
            <p>"The Whopper is amazing!"</p>
        </div>
        <div class="review">
            <p>"Best fast food burgers around."</p>
        </div>
    <?php endif; ?>
    
    <!-- Review Submission Form -->
    <section class="review-form">
        <h3 style="font-size: smaller; font-weight: 300;">Write a Review for Burger King</h3>
        <form action="submit_review.php" method="post">
            <input type="hidden" name="restaurant_name" value="Burger King">
            <textarea style="width: 95%;" name="review" id="review-text" rows="4" placeholder="Write your Burger King review here..." required></textarea>
            <button style="width: 100%;" type="submit" class="submit-btn">Submit Burger King Review</button>
        </form>
    </section>
</aside>
        </div>
